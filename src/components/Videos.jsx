...
const Videos = () => {
  ...
  return (
    <Stack direction={["column", "row"]} h={"100vh"} p={"2"}>
      <VStack w={"full"}>
        <video
          controls
        ...
        <VStack alignItems={"flex-start"} p={"6"} w={"full"} overflowY={"auto"}>
          {/* allign item ko left bhi kar sakhte hai */}
          <Heading>Sample Video {videoIdx + 1}</Heading>
          <Text>This is the description for the sample video to give demo</Text>
        </VStack>
      </VStack>
      ...
      <VStack
        ...
        overflowY={"auto"}
      >
        {/* how to use map in array in javascript */}
